...
@FeignClient(name="books-management",url="http://maktabatic-booksmanagement.herokuapp.com")
public interface BooksProxy {
    ...
    Book getBook(@RequestParam("rfid") String rb, @RequestParam("projection") String projection);
